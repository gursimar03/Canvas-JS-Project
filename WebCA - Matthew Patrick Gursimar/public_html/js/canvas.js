...
function backgroundColors(back) {
...
function eraserClick() {
    scribbleCanvasCtx.strokeStyle = backgroundColor
...
function clearcanvas1()
{
    ...
    doubleBufferCtx.clearRect(0, 0, doubleBuffer.width, doubleBuffer.height)
    ctx.fillStyle = "#23262a";
    ctx.fillRect(0, 0, canvas.width, canvas.height)
    offscreenCanvasCtx.fillStyle = "#23262a"
    offscreenCanvasCtx.fillRect(0, 0, offscreenCanvas.width, offscreenCanvas.height)
    scribbleCanvasCtx.fillStyle = "#23262a"
    scribbleCanvasCtx.fillRect(0, 0, scribbleCanvas.width, scribbleCanvas.height)
    doubleBufferCtx.fillStyle = "#23262a"
    doubleBufferCtx.fillRect(0, 0, doubleBuffer.width, doubleBuffer.height)
    deleteLayer()
    imageLayers()
}
